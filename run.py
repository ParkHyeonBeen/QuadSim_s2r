...
parser.add_argument("--init_max_ang", default=120, type=float, help="max initial degree angle for roll and pitch")
...
parser.add_argument("--mass", default=0.407, type=float, help="")
parser.add_argument("--gravity", default=9.8066, type=float, help="")
parser.add_argument("--length", default=0.1125, type=float, help="arm length")
parser.add_argument("--tc", default=0.060, type=float, help="time constant between motor and propeller")
parser.add_argument("--kt", default=9.168e-9, type=float, help="RPM to Thrust coefficient")
parser.add_argument("--kq", default=1.166e-10, type=float, help="RPM to Torque coefficient")
